...
@router.get("/students")
def list_students(search: str = "", sort_by: str = "id", order: str = "desc", page: int = 1, page_size: int = 10):
...
def edit_student(student_id: int, payload: dict):
...
@router.get("/staff")
def list_staff(search: str = "", sort_by: str = "id", order: str = "desc", page: int = 1, page_size: int = 10):
    page, page_size = _p(page, page_size)
...
@router.get("/fees")
def list_fees(search: str = "", month: str = "", sort_by: str = "id", order: str = "desc", page: int = 1, page_size: int = 10):
    page, page_size = _p(page, page_size)
    return ApiResponse(success=True, data=svc.list_fees(search, month, sort_by, order, page, page_size), message="Fees loaded")


@router.post("/fees")
def add_fee(payload: dict):
...
def remove_fee(fee_id: int):
    svc.delete_row("fees", fee_id)
    return ApiResponse(success=True, data={"id": fee_id}, message="Fee deleted")


@router.get("/expenses")
def list_expenses(search: str = "", month: str = "", sort_by: str = "id", order: str = "desc", page: int = 1, page_size: int = 10):
    page, page_size = _p(page, page_size)
...
@router.get("/files")
def list_files(search: str = "", sort_by: str = "id", order: str = "desc", page: int = 1, page_size: int = 10):
    page, page_size = _p(page, page_size)
...
def list_documents(search: str = "", sort_by: str = "id", order: str = "desc", page: int = 1, page_size: int = 10):
    page, page_size = _p(page, page_size)
...
def report_csv(report_type: str):
